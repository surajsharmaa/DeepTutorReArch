...
// if the synsets are the same
		...
		else
		{
			...
			getHypernyms(1.0, end, startset, new HashSet<ISynsetID>(), startpaths);
			// .......................................................................................................................................................
			...
			getHypernyms(1.0, start, endset, new HashSet<ISynsetID>(), endpaths);
...
//++
//++
	private void getHypernyms(double pathlength, ISynsetID find, HashSet<ISynsetID> current, HashSet<ISynsetID> visited, TreeMap<Double, HashSet<ISynsetID>> paths)
	{
		pathlength++;
		...
		{
			//LMC - must check if the node was already traversed before
		...
		if(!next.isEmpty())
		{
			...
			else
			{
				...
				getHypernyms(pathlength, find, next, visited, paths);
			}
		}
		return;
	}
