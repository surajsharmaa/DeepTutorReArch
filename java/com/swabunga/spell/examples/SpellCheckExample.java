...
public class SpellCheckExample implements SpellCheckListener {
  ...
  public SpellCheckExample(String phoneticFileName) {
    try {

      BufferedReader in = new BufferedReader(new FileReader("dict/example2.txt"));
      BufferedWriter out = new BufferedWriter(new FileWriter("dict/example2.corrected"));
      File phonetic = null;
      ...
      while (true) {
        ...
        if (!line.startsWith("#"))
        	out.write(spellCheck.autoSpelling(new StringWordTokenizer(line)) + "\n");
  ...
  public static void main(String[] args) {
    ...
    new SpellCheckExample(null);

    //System.out.println("\n\nRunning spell check against GenericTransformator");
    //new SpellCheckExample("dict/phonet.en");
  }
}
